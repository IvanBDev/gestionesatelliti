				                	...
				                	<c:forEach items="${satellite_list_attribute}" var="satelliteItem">
										<tr>
											...
											<td>
												...
												<a class="btn  btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/satellite/cambioDataPiuLancio/${satelliteItem.id }">Lancio</a>
												<a class="btn  btn-sm btn-outline-warning" href="${pageContext.request.contextPath}/satellite/rientroPiuDisattivamento/${satelliteItem.id }">Disattiva</a>
