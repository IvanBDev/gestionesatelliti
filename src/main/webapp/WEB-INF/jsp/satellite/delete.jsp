...
<html lang="it" class="h-100" >
	 <head>
	   ...
	   <title>Visualizza Satellite da eliminare dal DB</title>
	   ...
	   <body class="d-flex flex-column h-100">
			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<spring:hasBindErrors  name="remove_satellite_attr">
						<%-- alert errori --%>
						<div class="alert alert-danger " role="alert">
							Attenzione!! Si puó eliminare un satellite solo se é rientrato e dismesso oppure é stato solo censito
						</div>
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-footer'>
					    	<a href="${pageContext.request.contextPath }/satellite/remove/${remove_satellite_attr.id}" class='btn btn-danger' style='width:80px'>
