						...
						<div class="col-md-6">
							...
							<spring:bind path="denominazione">
								<input type="text" name="denominazione" id="denominazione"
									...
									placeholder="Inserire la denominazione del Satellite"
						...
						<div class="col-md-6">
							...
							<spring:bind path="codice">
								<input type="text" name="codice" id="codice"
									class="form-control ${status.error ? 'is-invalid' : ''}"
									placeholder="Inserire il codice del Satellite"
							...
							<spring:bind path="stato">
								<select class="form-select ${status.error ? 'is-invalid' : ''}"
									...
									<option value="IN_MOVIMENTO"
										${insert_satellite_attr.stato == 'IN_MOVIMENTO'?'selected':''}>IN_MOVIMRNTO</option>
									<option value="FISSO"
										${insert_satellite_attr.stato == 'FISSO'?'selected':''}>FISSO</option>
									<option value="DISATTIVATO"
										${insert_satellite_attr.stato == 'DISATTIVATO'?'selected':''}>DISATTIVATO</option>
								</select>
							</spring:bind>
