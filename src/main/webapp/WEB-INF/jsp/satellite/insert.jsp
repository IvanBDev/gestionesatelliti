							...
							<form:form modelAttribute="insert_satellite_attr" method="post" action="save" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<spring:bind path="denominazione">
										<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la denominazione del Satellite" value="${insert_satellite_attr.denominazione}" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="codice">
										<input type="text" name="codice" id="codice" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice del Satellite" value="${insert_satellite_attr.codice}" required>
									</spring:bind>
								...
								<div class="col-md-3">
								    ...
								    <spring:bind path="stato">
									    <select class="form-select ${status.error ? 'is-invalid' : ''}" id="stato" name="stato" required>
									    	...
									    	<option value="IN_MOVIMENTO" ${insert_satellite_attr.stato == 'IN_MOVIMENTO'?'selected':''}>IN_MOVIMRNTO</option>
